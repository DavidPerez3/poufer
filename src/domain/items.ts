...
export const ITEMS: Readonly<Record<ItemId, ItemDefinition>> = {
  ...
  beer: {
    id: 'beer', name: 'Cerveza', category: 'drink', icon: '🍺', priceMapocoins: 18,
  ...
  vermouth: {
    id: 'vermouth', name: 'Marianito rojo', category: 'drink', icon: '🍷', priceMapocoins: 25,
  ...
  'mixed-drink': {
    id: 'mixed-drink', name: 'Cubata', category: 'drink', icon: '🥃', priceMapocoins: 40,
  ...
  shot: {
    id: 'shot', name: 'Chupito', category: 'drink', icon: '🥃', priceMapocoins: 22,
  ...
  cigarette: {
    id: 'cigarette', name: 'Cigarro', category: 'smoke', icon: '🚬', priceMapocoins: 10,
  ...
  joint: {
    id: 'joint', name: 'Porro', category: 'smoke', icon: '🌿', priceMapocoins: 35,
  ...
  kebab: {
    id: 'kebab', name: 'Kebab', category: 'food', icon: '🌯', priceMapocoins: 28,
  ...
  sandwich: {
    id: 'sandwich', name: 'Bocata', category: 'food', icon: '🥖', priceMapocoins: 20,
